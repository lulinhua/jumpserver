...
class Asset(models.Model):
    ...
    memory_total = models.IntegerField(max_length=11, blank=True, null=True, verbose_name=u'内存')
    memory_available_percentage = models.IntegerField(max_length=11, blank=True, null=True, verbose_name=u'含cache空闲内存比')
    memory_free_percentage = models.IntegerField(max_length=11, blank=True, null=True, verbose_name=u'真实空闲内存比')
    ...
    comment = models.CharField(max_length=500, blank=True, null=True, verbose_name=u"备注")
